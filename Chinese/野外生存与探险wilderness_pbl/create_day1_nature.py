...
tb(s,0.7,3.5,4.4,0.9,"👀 我会认：森林山地草地\n　　　　　河边沙漠雪地",sz=15,b=True,c=DARK)
tb(s,5.3,3.5,4.3,0.9,"✍️ 我会写：森林山地河边",sz=15,b=True,c=DARK)
...
ENV_OBSERVE={
    # see_q, hear_q, feel_q
    "森林":("树, 叶子, 花?",       "鸟? 风? 虫?",      "凉还是暖?"),
    "山地":("石头, 山, 天空?",     "风的声音?",         "冷还是热?"),
    "草地":("草, 花, 虫?",         "风? 蜜蜂? 鸟?",    "软还是硬? 暖?"),
    "河边":("水, 鱼, 石头?",       "水流的声音?",       "凉还是暖? 湿吗?"),
    "沙漠":("沙, 太阳, 仙人掌?",   "安静还是有风?",   "热还是冷? 干?"),
    "雪地":("雪, 冰, 天空?",       "踩雪的声音?",       "冷还是暖?"),
}
...
# 31 Charades hints
# ============================================================
s=ns();n+=1;bg(s,CREAM);hb(s,"🎭 我演你猜表演提示 Acting Hints",GREEN_OK)
hints=[
    ("🌲","森林","弯腰走路、拨开树枝",FOREST),
...
OUT='/Users/Huan/0 projects/summercourse/Chinese/野外生存与探险wilderness_pbl/day1_nature.pptx'
