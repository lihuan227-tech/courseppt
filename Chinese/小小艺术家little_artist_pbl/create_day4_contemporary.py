...
GALLERY_NOTES={
    ...
    6:"老师备课:\n• 对称 = 一边和另一边一样\n• 大自然里到处都是对称: 蝴蝶, 雪花, 树叶, 我们的脸 / 身体\n• 中国剪纸艺术也用对称: 折 → 剪 → 打开\n• 黑白对称图案 + 重复 = 视觉冲击\n• 追问: 「你身上哪里是对称的？」「对称的图案让你想到什么？」",
}
...
pn(s,n)
notes(s,GALLERY_NOTES[5]+"\n\n关于《泉》(Fountain, 1917):\n• 杜尚把一个工厂里的小便池倒过来放, 签了假名「R.Mutt」, 送去美术展\n• 当时被拒绝, 现在是「20 世纪最有影响力的作品」之一\n• 这件作品问了一个大问题: 「什么是艺术？」「画家的「想法」算不算艺术？」\n• 后来艺术家发现: 想法 + 选择 + 摆放 = 艺术 (不一定要会画)\n• K-5 谨慎: 用「陶瓷物品」「水池」等替代说法\n• 追问: 「你身边有什么东西也能变成艺术？」「你觉得想法重要还是手艺重要？」")
